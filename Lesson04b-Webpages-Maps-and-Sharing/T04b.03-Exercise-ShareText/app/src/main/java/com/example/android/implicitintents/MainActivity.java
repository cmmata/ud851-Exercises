...
public class MainActivity extends AppCompatActivity {
    ...
    public void onClickShareTextButton(View v) {
        ...
        String textShared = "This is the text I want to share with the world";
    ...
    private void shareText(String textShared) {
        ...
        String chooseWindowTitle = "Which app do you want to use to open it?";

        // DONE (4) Use ShareCompat.IntentBuilder to build the Intent and start the chooser
        ShareCompat.IntentBuilder.from(this)
                .setChooserTitle(chooseWindowTitle)
                .setType(mimeType)
                .setText(textShared)
                .startChooser();
    }
